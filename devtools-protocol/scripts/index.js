 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const V=new class{handleAttributeExpressions(e,t,s,n){const i=t[0];if("."===i){return new k(e,t.slice(1),s).parts}return"@"===i?[new L(e,t.slice(1),n.eventContext)]:"?"===i?[new b(e,t.slice(1),s)]:new w(e,t,s).parts}handleTextExpression(e){return new y(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
